...
describe("LocalFolderOutputChannel", () => {
    ...
    it("constructor(folderUrl) should create a folder if folder doesnt already exist", () => {
        ...
        subject = new local_folder_output_channel_1.LocalFolderOutputChannel(folderUrl, silentConsole);
    ...
    it("constructor(folderUrl) should throw an error if it cannot create the folder", () => {
        ...
        expect(() => {
            subject = new local_folder_output_channel_1.LocalFolderOutputChannel(badlyFormedFolderUrl, silentConsole);
    ...
    it("constructor(folderUrl) should throw an error if it cannot write a file to the folder", () => {
        ...
        subject = new local_folder_output_channel_1.LocalFolderOutputChannel(folderUrl, silentConsole, myfs);
        expect(() => {
